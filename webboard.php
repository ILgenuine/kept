      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-10 webboard-position">
            ...
            <div class="row webboard-navigation">
              <div class="col-12">
            ...
            <div class="row">
              <div class="col-12">
                <div class="text-right webboard-text-time py-5 ">
                  <button type="button" class="btn btn-ghost webboard-bnt-comment-size mr-1">ยกเลิก</button>
